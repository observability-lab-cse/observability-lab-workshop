...
![Action Group](.attachments/create_ag.png)
...
![](.attachments/create_alert_rule.png)
...
![](.attachments/create_alert_log_based_query.png)

![](.attachments/create_alert_log_based_2.png)
...
![](.attachments/availability_standard_test.png)

The alert will be automatically created for you!

![](.attachments/availability_alert.png)
